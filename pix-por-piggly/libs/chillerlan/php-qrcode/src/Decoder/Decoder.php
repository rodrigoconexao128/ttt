...
use Piggly\WooPixGateway\Vendor\chillerlan\QRCode\Detector\Detector;
use Throwable;
...
final class Decoder
{
    ...
    private function decodeBitStream(BitBuffer $bitBuffer) : DecoderResult
    {
        ...
        return new DecoderResult(['rawBytes' => $this->bitBuffer, 'data' => $result, 'version' => $this->version, 'eccLevel' => $this->eccLevel, 'maskPattern' => $this->maskPattern, 'structuredAppendParity' => $parityData, 'structuredAppendSequence' => $symbolSequence]);
    }
    /**
     *
     */

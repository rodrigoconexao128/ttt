import {
  ...
  getAdminMediaByName,
  parseAdminMediaTags
} from "./chunk-VTL4Z6FC.js";
import {
  insertAgentMedia
} from "./chunk-HYSYG3D5.js";
import {
  storage
} from "./chunk-67AATMHD.js";
import {
  cancelFollowUp,
  followUpService,
...
async function generateTestToken(userId, agentName, company) {
  ...
  try {
    const { supabase } = await import("./supabaseAuth-RIFB2G2N.js");
...
[SISTEMA: O usu\xC3\xA1rio enviou uma m\xC3\xADdia do tipo ${mediaType}. Se for imagem/\xC3\xA1udio sem contexto, pergunte o que \xC3\xA9 (ex: cat\xC3\xA1logo, foto de produto, etc).]`;
  ...
  const { getSmartTriggers } = await import("./adminMediaStore-4ZE4OIBW.js");

...
__export(schema_exports, {
  adminAgentMedia: () => adminAgentMedia,
  adminAgentMediaRelations: () => adminAgentMediaRelations,
  adminAgentMediaSchema: () => adminAgentMediaSchema,
  adminConversations: () => adminConversations,
  adminMessages: () => adminMessages,
  adminQuickReplies: () => adminQuickReplies,
  adminWhatsappConnection: () => adminWhatsappConnection,
  adminWhatsappConnectionRelations: () => adminWhatsappConnectionRelations,
  admins: () => admins,
  agentDisabledConversations: () => agentDisabledConversations,
  agentMediaLibrary: () => agentMediaLibrary,
  agentMediaLibraryRelations: () => agentMediaLibraryRelations,
  agentMediaSchema: () => agentMediaSchema,
  ...
  audioConfigRelations: () => audioConfigRelations,
  audioMessageCounter: () => audioMessageCounter,
  audioMessageCounterRelations: () => audioMessageCounterRelations,
  bulkActionsLog: () => bulkActionsLog,
  businessAgentConfigSchema: () => businessAgentConfigSchema,
  businessAgentConfigs: () => businessAgentConfigs,
  businessCategories: () => businessCategories,
  connectionAgentSchema: () => connectionAgentSchema,
  connectionAgents: () => connectionAgents,
  connectionAgentsRelations: () => connectionAgentsRelations,
  connectionMemberSchema: () => connectionMemberSchema,
  connectionMembers: () => connectionMembers,
  connectionMembersRelations: () => connectionMembersRelations,
  contactLists: () => contactLists,
  conversationScheduledMessages: () => conversationScheduledMessages,
  conversationTags: () => conversationTags,
  conversationTagsRelations: () => conversationTagsRelations,
  conversations: () => conversations,
  conversationsRelations: () => conversationsRelations,
  coupons: () => coupons,
  customFieldDefinitionSchema: () => customFieldDefinitionSchema,
  customFieldDefinitions: () => customFieldDefinitions,
  customFieldDefinitionsRelations: () => customFieldDefinitionsRelations,
  customFieldValueSchema: () => customFieldValueSchema,
  customFieldValues: () => customFieldValues,
  customFieldValuesRelations: () => customFieldValuesRelations,
  dailyUsage: () => dailyUsage,
  dealHistory: () => dealHistory,
  dealHistoryRelations: () => dealHistoryRelations,
  deliveryCarts: () => deliveryCarts,
  deliveryConfig: () => deliveryConfig,
  deliveryConfigRelations: () => deliveryConfigRelations,
  deliveryConfigSchema: () => deliveryConfigSchema,
  deliveryOrderSchema: () => deliveryOrderSchema,
  deliveryOrders: () => deliveryOrders,
  deliveryOrdersRelations: () => deliveryOrdersRelations,
  exclusionConfig: () => exclusionConfig,
  exclusionConfigSchema: () => exclusionConfigSchema,
  exclusionList: () => exclusionList,
  exclusionListItemSchema: () => exclusionListItemSchema,
  flowItemSchema: () => flowItemSchema,
  followupConfigSchema: () => followupConfigSchema,
  followupConfigs: () => followupConfigs,
  followupConfigsRelations: () => followupConfigsRelations,
  followupLogs: () => followupLogs,
  funnelDeals: () => funnelDeals,
  funnelDealsRelations: () => funnelDealsRelations,
  funnelStages: () => funnelStages,
  funnelStagesRelations: () => funnelStagesRelations,
  googleCalendarTokens: () => googleCalendarTokens,
  insertAdminAgentMediaSchema: () => insertAdminAgentMediaSchema,
  insertAdminConversationSchema: () => insertAdminConversationSchema,
  insertAdminMessageSchema: () => insertAdminMessageSchema,
  insertAdminSchema: () => insertAdminSchema,
  insertAdminWhatsappConnectionSchema: () => insertAdminWhatsappConnectionSchema,
  insertAgentDisabledConversationSchema: () => insertAgentDisabledConversationSchema,
  insertAgentMediaSchema: () => insertAgentMediaSchema,
  insertAgentSchema: () => insertAgentSchema,
  insertAiAgentConfigSchema: () => insertAiAgentConfigSchema,
  insertAppointmentSchema: () => insertAppointmentSchema,
  insertAudioConfigSchema: () => insertAudioConfigSchema,
  insertBusinessAgentConfigSchema: () => insertBusinessAgentConfigSchema,
  insertConnectionAgentSchema: () => insertConnectionAgentSchema,
  insertConnectionMemberSchema: () => insertConnectionMemberSchema,
  insertContactListSchema: () => insertContactListSchema,
  insertConversationSchema: () => insertConversationSchema,
  insertConversationTagSchema: () => insertConversationTagSchema,
  ...
  insertExclusionConfigSchema: () => insertExclusionConfigSchema,
  insertExclusionListSchema: () => insertExclusionListSchema,
  insertFollowupConfigSchema: () => insertFollowupConfigSchema,
  insertFunnelDealSchema: () => insertFunnelDealSchema,
  insertFunnelStageSchema: () => insertFunnelStageSchema,
  insertMediaFlowItemSchema: () => insertMediaFlowItemSchema,
  insertMediaFlowSchema: () => insertMediaFlowSchema,
  insertMessageSchema: () => insertMessageSchema,
  insertPaymentHistorySchema: () => insertPaymentHistorySchema,
  insertPaymentReceiptSchema: () => insertPaymentReceiptSchema,
  insertPaymentReminderSchema: () => insertPaymentReminderSchema,
  insertPaymentSchema: () => insertPaymentSchema,
  insertPlanSchema: () => insertPlanSchema,
  insertProductSchema: () => insertProductSchema,
  insertProductsConfigSchema: () => insertProductsConfigSchema,
  insertProfessionalServiceSchema: () => insertProfessionalServiceSchema,
  insertQuickReplySchema: () => insertQuickReplySchema,
  insertResellerClientSchema: () => insertResellerClientSchema,
  insertResellerInvoiceItemsSchema: () => insertResellerInvoiceItemsSchema,
  insertResellerInvoiceSchema: () => insertResellerInvoiceSchema,
  insertResellerPaymentSchema: () => insertResellerPaymentSchema,
  ...
  insertScheduledStatusSchema: () => insertScheduledStatusSchema,
  insertSchedulingConfigSchema: () => insertSchedulingConfigSchema,
  insertSchedulingExceptionSchema: () => insertSchedulingExceptionSchema,
  insertSchedulingProfessionalSchema: () => insertSchedulingProfessionalSchema,
  insertSchedulingServiceSchema: () => insertSchedulingServiceSchema,
  insertSectorMemberSchema: () => insertSectorMemberSchema,
  insertSectorSchema: () => insertSectorSchema,
  insertSmartQrcodeSchema: () => insertSmartQrcodeSchema,
  insertStatusRotationItemSchema: () => insertStatusRotationItemSchema,
  insertStatusRotationSchema: () => insertStatusRotationSchema,
  ...
  insertUserFollowupLogSchema: () => insertUserFollowupLogSchema,
  insertUserQuickReplySchema: () => insertUserQuickReplySchema,
  insertWebsiteImportSchema: () => insertWebsiteImportSchema,
  insertWhatsappConnectionSchema: () => insertWhatsappConnectionSchema,
  insertWhatsappContactSchema: () => insertWhatsappContactSchema,
  insertWhatsappStatusSchema: () => insertWhatsappStatusSchema,
  loginAdminSchema: () => loginAdminSchema,
  mediaFlowItemSchema: () => mediaFlowItemSchema,
  mediaFlowItems: () => mediaFlowItems,
  mediaFlowItemsRelations: () => mediaFlowItemsRelations,
  mediaFlowSchema: () => mediaFlowSchema,
  mediaFlows: () => mediaFlows,
  mediaFlowsRelations: () => mediaFlowsRelations,
  ...
  mistralResponseSchema: () => mistralResponseSchema,
  orderItems: () => orderItems,
  orderItemsRelations: () => orderItemsRelations,
  paymentHistory: () => paymentHistory,
  paymentReceipts: () => paymentReceipts,
  paymentReceiptsRelations: () => paymentReceiptsRelations,
  ...
  productsConfigRelations: () => productsConfigRelations,
  productsConfigSchema: () => productsConfigSchema,
  productsRelations: () => productsRelations,
  professionalServices: () => professionalServices,
  professionalServicesRelations: () => professionalServicesRelations,
  qrcodeScanLogs: () => qrcodeScanLogs,
  qrcodeScanLogsRelations: () => qrcodeScanLogsRelations,
  resellerClientPaymentReceipts: () => resellerClientPaymentReceipts,
  resellerClients: () => resellerClients,
  resellerClientsRelations: () => resellerClientsRelations,
  resellerInvoiceItems: () => resellerInvoiceItems,
  resellerInvoiceItemsRelations: () => resellerInvoiceItemsRelations,
  resellerInvoices: () => resellerInvoices,
  resellerInvoicesRelations: () => resellerInvoicesRelations,
  resellerPayments: () => resellerPayments,
  resellerPaymentsRelations: () => resellerPaymentsRelations,
  resellerSchema: () => resellerSchema,
  resellers: () => resellers,
  resellersRelations: () => resellersRelations,
  routingLogs: () => routingLogs,
  routingLogsRelations: () => routingLogsRelations,
  saasOwnerReports: () => saasOwnerReports,
  salesFunnels: () => salesFunnels,
  salesFunnelsRelations: () => salesFunnelsRelations,
  scheduledMessageSchema: () => scheduledMessageSchema,
  scheduledMessages: () => scheduledMessages,
  scheduledMessagesRelations: () => scheduledMessagesRelations,
  scheduledStatus: () => scheduledStatus,
  schedulingConfig: () => schedulingConfig,
  schedulingConfigRelations: () => schedulingConfigRelations,
  schedulingExceptions: () => schedulingExceptions,
  schedulingProfessionals: () => schedulingProfessionals,
  schedulingProfessionalsRelations: () => schedulingProfessionalsRelations,
  schedulingServices: () => schedulingServices,
  schedulingServicesRelations: () => schedulingServicesRelations,
  sectorMembers: () => sectorMembers,
  sectorMembersRelations: () => sectorMembersRelations,
  sectors: () => sectors,
  sectorsRelations: () => sectorsRelations,
  sendMessageSchema: () => sendMessageSchema,
  sessions: () => sessions,
  smartQrcodeSchema: () => smartQrcodeSchema,
  smartQrcodes: () => smartQrcodes,
  smartQrcodesRelations: () => smartQrcodesRelations,
  statusHistory: () => statusHistory,
  statusRotation: () => statusRotation,
  statusRotationItems: () => statusRotationItems,
  ...
  teamMemberLoginSchema: () => teamMemberLoginSchema,
  teamMemberSchema: () => teamMemberSchema,
  teamMemberSessions: () => teamMemberSessions,
  teamMemberSessionsRelations: () => teamMemberSessionsRelations,
  teamMembers: () => teamMembers,
  teamMembersRelations: () => teamMembersRelations,
  ticketClosureLogs: () => ticketClosureLogs,
  ticketClosureLogsV4: () => ticketClosureLogsV4,
  updateAudioConfigSchema: () => updateAudioConfigSchema,
  updateSmartQrcodeSchema: () => updateSmartQrcodeSchema,
  userFollowupLogs: () => userFollowupLogs,
  userFollowupLogsRelations: () => userFollowupLogsRelations,
  userQuickReplies: () => userQuickReplies,
  users: () => users,
  usersRelations: () => usersRelations,
  websiteImports: () => websiteImports,
  whatsappConnections: () => whatsappConnections,
  whatsappConnectionsRelations: () => whatsappConnectionsRelations,
  whatsappContacts: () => whatsappContacts,
  whatsappContactsRelations: () => whatsappContactsRelations,
  whatsappStatusSchema: () => whatsappStatusSchema,
...
var policyViolations = pgTable("policy_violations", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  userId: varchar("user_id").notNull().references(() => users.id, { onDelete: "cascade" }),
  violationType: varchar("violation_type", { length: 100 }).notNull(),
  // religious_services, adult_content, illegal_activities, etc.
  description: text("description"),
  evidence: jsonb("evidence"),
  // Array de evidências (mensagens, prints, etc.)
...
var teamMemberSessions = pgTable("team_member_sessions", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
...
var contactLists = pgTable("contact_lists", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  userId: varchar("user_id").notNull().references(() => users.id, { onDelete: "cascade" }),
  name: varchar("name", { length: 255 }).notNull(),
  description: text("description"),
  // Array de contatos em JSONB para flexibilidade
  contacts: jsonb("contacts").$type().default([]),
...
var insertContactListSchema = createInsertSchema(contactLists);
var whatsappContacts = pgTable("whatsapp_contacts", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
...
var messages = pgTable("messages", {
  ...
  // URL or base64 data (Supabase Storage)
  ...
  // Chave de descriptografia (base64)
  directPath: text("direct_path"),
  // Caminho direto no servidor WhatsApp
  mediaUrlOriginal: text("media_url_original"),
  // URL original do WhatsApp
  createdAt: timestamp("created_at").defaultNow()
});
var ticketClosureLogs = pgTable("ticket_closure_logs", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  conversationId: varchar("conversation_id").notNull().references(() => conversations.id, { onDelete: "cascade" }),
...
var aiAgentConfig = pgTable("ai_agent_config", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  userId: varchar("user_id").notNull().unique().references(() => users.id, { onDelete: "cascade" }),
  prompt: text("prompt").notNull(),
  isActive: boolean("is_active").default(false).notNull(),
  model: varchar("model", { length: 100 }).default("openai/gpt-oss-20b").notNull(),
  // CORRIGIDO: usar modelo do OpenRouter
  triggerPhrases: text("trigger_phrases").array(),
  messageSplitChars: integer("message_split_chars").default(400),
  responseDelaySeconds: integer("response_delay_seconds").default(30),
  // Tempo de espera antes de responder (acumulação de mensagens)
  fetchHistoryOnFirstResponse: boolean("fetch_history_on_first_response").default(false).notNull(),
  // Buscar histórico do WhatsApp ao responder pela primeira vez
  pauseOnManualReply: boolean("pause_on_manual_reply").default(true).notNull(),
  // Pausar IA automaticamente quando dono responde manualmente
  autoReactivateMinutes: integer("auto_reactivate_minutes"),
  // Tempo em minutos para reativar IA automaticamente (NULL = nunca)
  // PARTE 5 - Modo Fluxo: chatbot com roteiro pré-definido
  flowScript: text("flow_script"),
  // Roteiro/prompt de fluxo em texto livre
  flowModeActive: boolean("flow_mode_active").default(false).notNull(),
  // Se TRUE, IA segue estritamente o roteiro (sem improviso)
  // PARTE 6 - Saudação personalizada e endereço fixo
  customGreeting: text("custom_greeting"),
  // Saudação fixa, suporta {nome}. NULL = IA improvisa
  customAddress: text("custom_address"),
  // Endereço fixo do negócio. NULL = não informar
  greetingVariation: boolean("greeting_variation").default(false).notNull(),
  // Se TRUE, IA varia a saudação naturalmente
  greetingEnabled: boolean("greeting_enabled").default(false).notNull(),
  // Se TRUE, saudação personalizada está ATIVA
  addressEnabled: boolean("address_enabled").default(false).notNull(),
  // Se TRUE, endereço fixo está ATIVO
  // PARTE 7 - Horário de funcionamento
  businessHoursEnabled: boolean("business_hours_enabled").default(false).notNull(),
  // Se TRUE, horário de funcionamento está ATIVO
  businessHours: jsonb("business_hours").$type().default({
  ...
  offHoursMessage: text("off_hours_message").default("Ol\xE1! No momento estamos fora do hor\xE1rio de atendimento. Retornaremos em breve!"),
  createdAt: timestamp("created_at").defaultNow(),
  updatedAt: timestamp("updated_at").defaultNow()
});
var agentMediaLibrary = pgTable("agent_media_library", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  userId: varchar("user_id").notNull().references(() => users.id, { onDelete: "cascade" }),
  // Identificação da mídia (usado no prompt para o Mistral)
  name: varchar("name", { length: 100 }).notNull(),
  // Ex: "AUDIO_PRECO", "IMG_BOAS_VINDAS"
  // Tipo da mídia
  mediaType: varchar("media_type", { length: 20 }).notNull(),
  // 'audio', 'image', 'video', 'document', 'flow'
  // Armazenamento
  storageUrl: text("storage_url").notNull().default(""),
  // URL pública ou base64 (vazio para tipo 'flow')
  ...
  // "Explica o preço do produto X" - usado pela IA para decidir
  whenToUse: text("when_to_use"),
  // "Quando o cliente perguntar sobre preço"
  caption: text("caption"),
  // Legenda que vai junto com a imagem/vídeo no WhatsApp
  transcription: text("transcription"),
  // Transcrição automática de áudios
  // Opções de áudio
  isPtt: boolean("is_ptt").default(true),
  // PTT = Push-to-talk (mensagem de voz gravada)
  // Opção de envio combinado
  sendAlone: boolean("send_alone").default(false),
  // true = enviar sozinha, false = pode ser combinada com outras
  ...
  flowItems: jsonb("flow_items").$type(),
  // Ordenação e status
  isActive: boolean("is_active").default(true).notNull(),
...
var businessAgentConfigs = pgTable("business_agent_configs", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  userId: varchar("user_id").notNull().unique().references(() => users.id, { onDelete: "cascade" }),
  // Identity Layer
  ...
  productsServices: jsonb("products_services").$type().default([]),
  businessInfo: jsonb("business_info").$type().default({}),
  faqItems: jsonb("faq_items").$type().default([]),
  policies: jsonb("policies").$type().default({}),
  // Guardrails Layer
  ...
  // Personality Layer
  toneOfVoice: varchar("tone_of_voice", { length: 50 }).default("amig\xE1vel").notNull(),
  communicationStyle: varchar("communication_style", { length: 50 }).default("claro e direto").notNull(),
  emojiUsage: varchar("emoji_usage", { length: 20 }).default("moderado").notNull(),
  // nunca, raro, moderado, frequente
  formalityLevel: integer("formality_level").default(5).notNull(),
  // 1-10 scale
  ...
  notificationMode: varchar("notification_mode", { length: 20 }).default("ai").notNull(),
  // "ai" | "manual" | "both"
  notificationManualKeywords: text("notification_manual_keywords"),
  // Comma-separated keywords for manual mode
  ...
  // ecommerce, professional, health, education, realestate
  // Metadata
  version: integer("version").default(1).notNull(),
  createdAt: timestamp("created_at").defaultNow(),
  updatedAt: timestamp("updated_at").defaultNow()
});
var agentDisabledConversations = pgTable("agent_disabled_conversations", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  ...
  ownerLastReplyAt: timestamp("owner_last_reply_at").defaultNow(),
  // Quando o dono respondeu pela última vez
  autoReactivateAfterMinutes: integer("auto_reactivate_after_minutes"),
  // NULL = nunca, número = minutos para reativar
  clientHasPendingMessage: boolean("client_has_pending_message").default(false),
  // Cliente enviou mensagem após pausa?
  clientLastMessageAt: timestamp("client_last_message_at"),
  // Quando cliente enviou última mensagem
  createdAt: timestamp("created_at").defaultNow()
});
var websiteImports = pgTable("website_imports", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  userId: varchar("user_id").notNull().references(() => users.id, { onDelete: "cascade" }),
  ...
  extractedProducts: jsonb("extracted_products").$type().default([]),
  extractedInfo: jsonb("extracted_info").$type().default({}),
...
var adminWhatsappConnection = pgTable("admin_whatsapp_connection", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
...
var adminConversations = pgTable("admin_conversations", {
  ...
  // paid, unpaid, pending
  followupForNonPayers: boolean("followup_for_non_payers").default(true).notNull(),
  // Toggle for non-payer follow-up
  followupConfig: jsonb("followup_config").$type().default({
    enabled: true,
    maxAttempts: 8,
...
var adminAgentMedia = pgTable("admin_agent_media", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  adminId: varchar("admin_id").notNull().references(() => admins.id, { onDelete: "cascade" }),
  name: varchar("name", { length: 255 }).notNull(),
...
var mediaFlows = pgTable("media_flows", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
...
var mediaFlowItems = pgTable("media_flow_items", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
...
var plans = pgTable("plans", {
  ...
  // Valor antes do desconto (se houver)
  periodicidade: varchar("periodicidade", { length: 20 }).default("mensal").notNull(),
  // mensal, anual
  tipo: varchar("tipo", { length: 50 }).default("padrao").notNull(),
  // padrao, anual, implementacao, personalizado
  descontoPercent: integer("desconto_percent").default(0),
  // Percentual de desconto
  badge: varchar("badge", { length: 50 }),
  // Ex: "Mais Popular", "5% OFF", etc
  ...
  caracteristicas: jsonb("caracteristicas").$type(),
  // Lista de features do plano
  ativo: boolean("ativo").default(true).notNull(),
  // Mercado Pago fields
  mpPlanId: varchar("mp_plan_id", { length: 255 }),
  // ID do plano no Mercado Pago
  valorPrimeiraCobranca: decimal("valor_primeira_cobranca", { precision: 10, scale: 2 }),
  // Valor diferente na primeira cobrança
  codigoPersonalizado: varchar("codigo_personalizado", { length: 50 }).unique(),
  // Código para planos personalizados
  isPersonalizado: boolean("is_personalizado").default(false),
  // Se é um plano personalizado
  frequenciaDias: integer("frequencia_dias").default(30),
  // Frequência de cobrança em dias
  trialDias: integer("trial_dias").default(0),
  // Dias de trial gratuito
  // Link único para cadastro - quando cliente entra por este link, só vê este plano
  linkSlug: varchar("link_slug", { length: 100 }).unique(),
  // Slug único para URL ex: plano-mensal-abc123
  createdAt: timestamp("created_at").defaultNow(),
  updatedAt: timestamp("updated_at").defaultNow()
});
var subscriptions = pgTable("subscriptions", {
  ...
  couponPrice: decimal("coupon_price", { precision: 10, scale: 2 }),
  ...
  // Email do pagador
  paymentMethod: varchar("payment_method", { length: 50 }).default("mercadopago"),
  // Método de pagamento
  createdAt: timestamp("created_at").defaultNow(),
  updatedAt: timestamp("updated_at").defaultNow()
});
...
var paymentHistory = pgTable("payment_history", {
  ...
  // Detalhe do status (accredited, cc_rejected_*, etc)
  // Tipo de pagamento
  paymentType: varchar("payment_type", { length: 50 }).default("recurring").notNull(),
  // first_payment, setup_fee, recurring, refund
...
var resellerClientPaymentReceipts = pgTable("reseller_client_payment_receipts", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  // Referências
  ...
  userId: varchar("user_id").notNull().references(() => users.id, { onDelete: "cascade" }),
  // O usuário que é cliente do revendedor
...
var coupons = pgTable("coupons", {
  ...
  // Código do cupom (ex: BLACKFRIDAY, WELCOME2025)
  discountType: text("discount_type").default("fixed_price").notNull(),
  // Tipo de desconto
  discountValue: decimal("discount_value", { precision: 10, scale: 2 }).default("0").notNull(),
  // Valor do desconto
  finalPrice: decimal("final_price", { precision: 10, scale: 2 }),
  // Preço final com cupom aplicado
  isActive: boolean("is_active").default(true),
  maxUses: integer("max_uses"),
  // null = ilimitado
  currentUses: integer("current_uses").default(0),
  // Quantas vezes foi usado
  applicablePlans: jsonb("applicable_plans").$type(),
  // Planos onde o cupom é válido (null = todos)
...
var followupLogs = pgTable("followup_logs", {
...
var followupConfigs = pgTable("followup_configs", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  userId: varchar("user_id").notNull().unique().references(() => users.id, { onDelete: "cascade" }),
...
var userFollowupLogs = pgTable("user_followup_logs", {
  id: integer("id").primaryKey().generatedAlwaysAsIdentity(),
  ...
  messageContent: text("message_content"),
  aiDecision: jsonb("ai_decision").$type(),
...
var conversationTags = pgTable("conversation_tags", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  conversationId: varchar("conversation_id").notNull().references(() => conversations.id, { onDelete: "cascade" }),
...
var tagSchema = z.object({
  ...
  color: z.string().regex(/^#[0-9A-Fa-f]{6}$/, "Cor inv\xE1lida").default("#6b7280"),
  icon: z.string().max(50).optional(),
  description: z.string().max(500).optional(),
  position: z.number().int().min(0).default(0)
});
var insertConversationTagSchema = createInsertSchema(conversationTags).omit({
  id: true,
  assignedAt: true
});
...
var conversationTagsRelations = relations(conversationTags, ({ one }) => ({
...
var mediaFlowsRelations = relations(mediaFlows, ({ one, many }) => ({
  agent: one(agents, {
...
var mediaFlowItemsRelations = relations(mediaFlowItems, ({ one }) => ({
  flow: one(mediaFlows, {
...
var whatsappConnectionsRelations = relations(whatsappConnections, ({ one, many }) => ({
  user: one(users, {
...
var whatsappContactsRelations = relations(whatsappContacts, ({ one }) => ({
...
var paymentReceiptsRelations = relations(paymentReceipts, ({ one }) => ({
  user: one(users, {
...
var adminWhatsappConnectionRelations = relations(adminWhatsappConnection, ({ one }) => ({
  admin: one(admins, {
...
var agentSchema = z.object({
  name: z.string().min(1, "Nome do agente \xC3\xA9 obrigat\xC3\xB3rio").max(255),
  prompt: z.string().min(1, "Prompt do agente \xC3\xA9 obrigat\xC3\xB3rio"),
...
var insertMediaFlowSchema = createInsertSchema(mediaFlows).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
var mediaFlowSchema = z.object({
  agentId: z.string().min(1, "Agente \xC3\xA9 obrigat\xC3\xB3rio"),
  name: z.string().min(1, "Nome do fluxo \xC3\xA9 obrigat\xC3\xB3rio").max(255),
  description: z.string().max(2e3).optional().nullable(),
  isActive: z.boolean().default(true)
});
var insertMediaFlowItemSchema = createInsertSchema(mediaFlowItems).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
var mediaFlowItemSchema = z.object({
  flowId: z.string().min(1, "Fluxo \xC3\xA9 obrigat\xC3\xB3rio"),
  mediaId: z.string().optional().nullable(),
  mediaName: z.string().min(1, "Nome da m\xC3\xADdia \xC3\xA9 obrigat\xC3\xB3rio").max(255),
  mediaType: z.enum(["audio", "image", "video", "document"]),
  storageUrl: z.string().min(1, "URL da m\xC3\xADdia \xC3\xA9 obrigat\xC3\xB3ria"),
  caption: z.string().max(2e3).optional().nullable(),
...
var insertWhatsappContactSchema = createInsertSchema(whatsappContacts).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
  lastSyncedAt: true
...
var insertAiAgentConfigSchema = createInsertSchema(aiAgentConfig).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
var insertAgentDisabledConversationSchema = createInsertSchema(agentDisabledConversations).omit({
  id: true,
  createdAt: true
});
var insertWebsiteImportSchema = createInsertSchema(websiteImports).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
...
var insertPaymentHistorySchema = createInsertSchema(paymentHistory).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
var insertPaymentReceiptSchema = createInsertSchema(paymentReceipts).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
...
var insertAdminWhatsappConnectionSchema = createInsertSchema(adminWhatsappConnection).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
var insertAdminConversationSchema = createInsertSchema(adminConversations).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
...
var insertFollowupConfigSchema = createInsertSchema(followupConfigs).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
var followupConfigSchema = z.object({
  userId: z.string(),
  // IMPORTANTE: Follow-up DESATIVADO por padrão - usuário precisa ativar manualmente
  ...
  tone: z.enum(["consultivo", "vendedor", "humano", "t\xE9cnico"]).default("consultivo"),
...
var insertUserFollowupLogSchema = createInsertSchema(userFollowupLogs).omit({
  id: true,
  executedAt: true
});
var followupConfigsRelations = relations(followupConfigs, ({ one }) => ({
  user: one(users, {
    fields: [followupConfigs.userId],
    references: [users.id]
  })
}));
var userFollowupLogsRelations = relations(userFollowupLogs, ({ one }) => ({
  conversation: one(conversations, {
...
var insertBusinessAgentConfigSchema = createInsertSchema(businessAgentConfigs).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
var businessAgentConfigSchema = z.object({
  userId: z.string(),
  agentName: z.string().min(1, "Nome do agente \xE9 obrigat\xF3rio"),
  agentRole: z.string().min(1, "Fun\xE7\xE3o do agente \xE9 obrigat\xF3ria"),
  companyName: z.string().min(1, "Nome da empresa \xE9 obrigat\xF3rio"),
  ...
  toneOfVoice: z.string().default("amig\xE1vel"),
...
var insertAgentMediaSchema = createInsertSchema(agentMediaLibrary).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
var flowItemSchema = z.object({
  id: z.string(),
  order: z.number(),
...
var agentMediaSchema = z.object({
  userId: z.string(),
  name: z.string().min(1, "Nome da m\xEDdia \xE9 obrigat\xF3rio").max(100),
  mediaType: z.enum(["audio", "image", "video", "document", "flow"]),
  storageUrl: z.string().optional().default(""),
  // vazio para 'flow'
  fileName: z.string().optional(),
  ...
  caption: z.string().optional(),
  // Legenda que vai com a imagem/vídeo
  transcription: z.string().optional(),
  isPtt: z.boolean().default(true),
  // Push-to-talk (áudio aparece como gravado)
  sendAlone: z.boolean().default(false),
  // Enviar sozinha ou pode combinar com outras
  isActive: z.boolean().default(true),
...
var agentMediaLibraryRelations = relations(agentMediaLibrary, ({ one }) => ({
  user: one(users, {
    fields: [agentMediaLibrary.userId],
    references: [users.id]
  })
}));
var insertAdminAgentMediaSchema = createInsertSchema(adminAgentMedia).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
var adminAgentMediaSchema = z.object({
  adminId: z.string(),
  name: z.string().min(1, "Nome da m\xEDdia \xE9 obrigat\xF3rio").max(100).regex(/^[A-Z0-9_]+$/, "Nome deve ser em MAI\xDASCULAS com underscores (ex: COMO_FUNCIONA)"),
  mediaType: z.enum(["audio", "image", "video", "document"]),
  storageUrl: z.string().min(1, "URL de armazenamento \xE9 obrigat\xF3ria"),
  fileName: z.string().optional(),
  fileSize: z.number().optional(),
  mimeType: z.string().optional(),
  durationSeconds: z.number().optional(),
...
var adminAgentMediaRelations = relations(adminAgentMedia, ({ one }) => ({
  admin: one(admins, {
    fields: [adminAgentMedia.adminId],
    references: [admins.id]
  })
}));
var adminQuickReplies = pgTable("admin_quick_replies", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
...
var insertQuickReplySchema = createInsertSchema(adminQuickReplies).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
  usageCount: true
});
var userQuickReplies = pgTable("user_quick_replies", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  userId: varchar("user_id").references(() => users.id, { onDelete: "cascade" }),
  title: varchar("title", { length: 100 }).notNull(),
  content: text("content").notNull(),
...
var insertUserQuickReplySchema = createInsertSchema(userQuickReplies).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
  usageCount: true
});
var mistralResponseSchema = z.object({
  ...
  actions: z.array(z.union([
    z.object({
      ...
      media_name: z.string(),
      // Nome da mídia na biblioteca (ex: AUDIO_PRECO)
...
var exclusionList = pgTable("exclusion_list", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  userId: varchar("user_id").notNull().references(() => users.id, { onDelete: "cascade" }),
...
var exclusionConfig = pgTable("exclusion_config", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  userId: varchar("user_id").notNull().unique().references(() => users.id, { onDelete: "cascade" }),
...
var insertExclusionListSchema = createInsertSchema(exclusionList).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
var insertExclusionConfigSchema = createInsertSchema(exclusionConfig).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
var exclusionListItemSchema = z.object({
  phoneNumber: z.string().min(8, "N\xFAmero de telefone inv\xE1lido").max(20),
  contactName: z.string().max(255).optional(),
  reason: z.string().optional(),
  excludeFromFollowup: z.boolean().default(true),
  isActive: z.boolean().default(true)
});
var exclusionConfigSchema = z.object({
  isEnabled: z.boolean().default(true),
  followupExclusionEnabled: z.boolean().default(true)
});
var dailyUsage = pgTable("daily_usage", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  userId: varchar("user_id").notNull().references(() => users.id, { onDelete: "cascade" }),
...
var insertDailyUsageSchema = createInsertSchema(dailyUsage).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
var salesFunnels = pgTable("sales_funnels", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  userId: varchar("user_id").notNull().references(() => users.id, { onDelete: "cascade" }),
  name: varchar("name", { length: 255 }).notNull(),
...
var funnelStages = pgTable("funnel_stages", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
...
var funnelDeals = pgTable("funnel_deals", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  ...
  valuePeriod: varchar("value_period", { length: 20 }).default("mensal"),
  // mensal, anual, único
  priority: varchar("priority", { length: 20 }).default("M\xE9dia"),
  // Alta, Média, Baixa
...
var dealHistory = pgTable("deal_history", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  ...
  action: varchar("action", { length: 50 }).notNull(),
  // created, moved, updated, won, lost
  notes: text("notes"),
...
var dealHistoryRelations = relations(dealHistory, ({ one }) => ({
...
var insertSalesFunnelSchema = createInsertSchema(salesFunnels).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
var insertFunnelStageSchema = createInsertSchema(funnelStages).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
var insertFunnelDealSchema = createInsertSchema(funnelDeals).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
var schedulingConfig = pgTable("scheduling_config", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  userId: varchar("user_id").notNull().unique().references(() => users.id, { onDelete: "cascade" }),
  // Status
  isEnabled: boolean("is_enabled").default(false).notNull(),
  ...
  serviceDuration: integer("service_duration").default(60),
  // Duração em minutos
  ...
  // Quantos dias à frente pode agendar
  ...
  // Permitir cancelamento pelo cliente via IA
  ...
  confirmationMessage: text("confirmation_message").default("Seu agendamento foi confirmado! \u{1F4C5}"),
  reminderMessage: text("reminder_message").default("Lembrete: Voc\xEA tem um agendamento amanh\xE3!"),
...
var schedulingExceptions = pgTable("scheduling_exceptions", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  userId: varchar("user_id").notNull().references(() => users.id, { onDelete: "cascade" }),
  exceptionDate: varchar("exception_date", { length: 20 }).notNull(),
  // YYYY-MM-DD
  exceptionType: varchar("exception_type", { length: 50 }).notNull(),
  // blocked, modified_hours, holiday
  // Se modified_hours
...
var scheduledStatus = pgTable("scheduled_status", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  userId: varchar("user_id").notNull().references(() => users.id, { onDelete: "cascade" }),
...
var statusRotation = pgTable("status_rotation", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  userId: varchar("user_id").notNull().references(() => users.id, { onDelete: "cascade" }),
...
var statusRotationItems = pgTable("status_rotation_items", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
...
var schedulingServices = pgTable("scheduling_services", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  userId: varchar("user_id").notNull().references(() => users.id, { onDelete: "cascade" }),
...
var schedulingProfessionals = pgTable("scheduling_professionals", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  userId: varchar("user_id").notNull().references(() => users.id, { onDelete: "cascade" }),
  ...
  // Profissional padrão quando não especificado
...
var schedulingConfigRelations = relations(schedulingConfig, ({ one }) => ({
...
var schedulingServicesRelations = relations(schedulingServices, ({ one, many }) => ({
  user: one(users, { fields: [schedulingServices.userId], references: [users.id] }),
  professionals: many(professionalServices)
}));
var schedulingProfessionalsRelations = relations(schedulingProfessionals, ({ one, many }) => ({
...
var insertSchedulingConfigSchema = createInsertSchema(schedulingConfig).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
...
var insertSchedulingExceptionSchema = createInsertSchema(schedulingExceptions).omit({
  id: true,
  createdAt: true
});
var insertSchedulingServiceSchema = createInsertSchema(schedulingServices).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
var insertSchedulingProfessionalSchema = createInsertSchema(schedulingProfessionals).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
var insertProfessionalServiceSchema = createInsertSchema(professionalServices).omit({
  id: true,
  createdAt: true
});
var insertScheduledStatusSchema = createInsertSchema(scheduledStatus).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
  lastSentAt: true
});
var insertStatusRotationSchema = createInsertSchema(statusRotation).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
  lastSentAt: true
});
var insertStatusRotationItemSchema = createInsertSchema(statusRotationItems).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
  lastSentAt: true
...
var resellers = pgTable("resellers", {
  ...
  pixHolderName: varchar("pix_holder_name", { length: 255 }),
  // Nome do titular da conta
  pixBankName: varchar("pix_bank_name", { length: 100 }),
  // Nome do banco (Nubank, Inter, etc)
  ...
  nextPaymentDate: timestamp("next_payment_date"),
  // Próximo vencimento do revendedor
  resellerStatus: varchar("reseller_status", { length: 50 }).default("active"),
...
var resellerClients = pgTable("reseller_clients", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  resellerId: varchar("reseller_id").notNull().references(() => resellers.id, { onDelete: "cascade" }),
  userId: varchar("user_id").notNull().unique().references(() => users.id, { onDelete: "cascade" }),
  // Status
...
var resellerPayments = pgTable("reseller_payments", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  resellerId: varchar("reseller_id").notNull().references(() => resellers.id, { onDelete: "cascade" }),
  ...
  // client_creation, recurring, setup_fee, monthly_fee
  // Status
  status: varchar("status", { length: 50 }).default("pending").notNull(),
  // pending, approved, rejected, refunded
  statusDetail: varchar("status_detail", { length: 100 }),
...
var paymentReminders = pgTable("payment_reminders", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
...
var resellersRelations = relations(resellers, ({ one, many }) => ({
...
var resellerClientsRelations = relations(resellerClients, ({ one, many }) => ({
...
var resellerPaymentsRelations = relations(resellerPayments, ({ one }) => ({
...
var resellerInvoices = pgTable("reseller_invoices", {
...
var resellerInvoiceItems = pgTable("reseller_invoice_items", {
  id: serial("id").primaryKey(),
...
var resellerInvoicesRelations = relations(resellerInvoices, ({ one, many }) => ({
  reseller: one(resellers, { fields: [resellerInvoices.resellerId], references: [resellers.id] }),
  items: many(resellerInvoiceItems)
}));
var resellerInvoiceItemsRelations = relations(resellerInvoiceItems, ({ one }) => ({
...
var insertResellerClientSchema = createInsertSchema(resellerClients).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
var insertResellerPaymentSchema = createInsertSchema(resellerPayments).omit({
  id: true,
  createdAt: true
});
var insertPaymentReminderSchema = createInsertSchema(paymentReminders).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
  sentAt: true
});
var insertResellerInvoiceSchema = createInsertSchema(resellerInvoices).omit({
  id: true,
  createdAt: true
});
var insertResellerInvoiceItemsSchema = createInsertSchema(resellerInvoiceItems).omit({
  id: true,
  createdAt: true
});
var customFieldDefinitions = pgTable("custom_field_definitions", {
  ...
  // Prompt para IA extrair automaticamente
...
var customFieldValues = pgTable("custom_field_values", {
  ...
  // 0.00 a 1.00
  // Auditoria
  lastEditedBy: varchar("last_edited_by", { length: 50 }).default("user"),
  // user, ai, system
  createdAt: timestamp("created_at").defaultNow(),
  updatedAt: timestamp("updated_at").defaultNow()
}, (table) => [
...
var customFieldDefinitionsRelations = relations(customFieldDefinitions, ({ one, many }) => ({
  user: one(users, {
...
var customFieldValuesRelations = relations(customFieldValues, ({ one }) => ({
...
var insertCustomFieldDefinitionSchema = createInsertSchema(customFieldDefinitions).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
var customFieldDefinitionSchema = z.object({
  name: z.string().min(1).max(100).regex(/^[a-z0-9_]+$/, "Use apenas letras min\xFAsculas, n\xFAmeros e underscore"),
...
var insertCustomFieldValueSchema = createInsertSchema(customFieldValues).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
var customFieldValueSchema = z.object({
...
var productsConfig = pgTable("products_config", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  userId: varchar("user_id").notNull().references(() => users.id, { onDelete: "cascade" }),
  isActive: boolean("is_active").default(false),
  sendToAi: boolean("send_to_ai").default(true),
  aiInstructions: text("ai_instructions").default("Use esta lista de produtos para responder perguntas sobre disponibilidade, pre\xE7os e detalhes dos produtos. Seja preciso com valores e quantidades."),
  displayInstructions: text("display_instructions").default("Quando o cliente pedir a lista de produtos, mostre cada produto em uma linha com nome, pre\xE7o e disponibilidade."),
  createdAt: timestamp("created_at").defaultNow(),
  updatedAt: timestamp("updated_at").defaultNow()
});
...
var productsConfigRelations = relations(productsConfig, ({ one }) => ({
  user: one(users, {
...
var productSchema = z.object({
  name: z.string().min(1, "Nome do produto \xE9 obrigat\xF3rio").max(500),
  price: z.string().or(z.number()).optional().nullable(),
  stock: z.number().int().min(0).optional().default(0),
  description: z.string().max(5e3).optional().nullable(),
  category: z.string().max(200).optional().nullable(),
  link: z.string().url().max(1e3).optional().nullable().or(z.literal("")),
  sku: z.string().max(100).optional().nullable(),
  unit: z.string().max(50).optional().default("un"),
  isActive: z.boolean().default(true)
});
var insertProductsConfigSchema = createInsertSchema(productsConfig).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
var productsConfigSchema = z.object({
  isActive: z.boolean().default(false),
  sendToAi: z.boolean().default(true),
  aiInstructions: z.string().max(2e3).optional()
});
var deliveryConfig = pgTable("delivery_config", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  userId: varchar("user_id").notNull().references(() => users.id, { onDelete: "cascade" }),
  isActive: boolean("is_active").default(false),
  sendToAi: boolean("send_to_ai").default(true),
  ...
  aiInstructions: text("ai_instructions").default("Voc\xEA \xE9 um atendente de delivery. Seja simp\xE1tico, ajude o cliente a escolher, anote os pedidos corretamente com todos os detalhes e sempre confirme antes de finalizar."),
  displayInstructions: text("display_instructions").default("Quando o cliente pedir o card\xE1pio, liste cada item em uma linha separada com emoji, nome e pre\xE7o. Organize por categoria."),
...
var deliveryCarts = pgTable("delivery_carts", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  userId: varchar("user_id").notNull().references(() => users.id, { onDelete: "cascade" }),
...
var deliveryConfigRelations = relations(deliveryConfig, ({ one }) => ({
...
var menuCategorySchema = z.object({
  name: z.string().min(1, "Nome \xE9 obrigat\xF3rio").max(100),
...
var menuItemSchema = z.object({
  ...
  name: z.string().min(1, "Nome \xE9 obrigat\xF3rio").max(200),
...
var deliveryOrderSchema = z.object({
...
var teamMemberSessionsRelations = relations(teamMemberSessions, ({ one }) => ({
...
var teamMemberLoginSchema = z.object({
  email: z.string().email("Email inv\xE1lido"),
  password: z.string().min(6, "Senha deve ter pelo menos 6 caracteres"),
  ownerId: z.string().optional()
  // ID do dono da conta (para identificar a qual conta o membro pertence)
});
var whatsappStatuses = pgTable("whatsapp_statuses", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  name: varchar("name", { length: 255 }).notNull(),
...
var statusHistory = pgTable("status_history", {
  ...
  rotationUsed: varchar("rotation_used")
  // Track which rotation was used
});
var insertWhatsappStatusSchema = createInsertSchema(whatsappStatuses).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
var whatsappStatusSchema = z.object({
  name: z.string().min(1, "Nome \xE9 obrigat\xF3rio").max(255),
...
var audioConfig = pgTable("audio_config", {
  id: uuid("id").primaryKey().defaultRandom(),
  userId: varchar("user_id", { length: 255 }).notNull().unique().references(() => users.id, { onDelete: "cascade" }),
  isEnabled: boolean("is_enabled").default(true).notNull(),
  voiceType: text("voice_type").default("female").notNull(),
  // "female" ou "male"
  speed: numeric("speed", { precision: 3, scale: 2 }).default("1.00").notNull(),
  // 0.5 a 2.0
  createdAt: timestamp("created_at", { withTimezone: true }).defaultNow().notNull(),
  updatedAt: timestamp("updated_at", { withTimezone: true }).defaultNow().notNull()
});
var audioMessageCounter = pgTable("audio_message_counter", {
  id: uuid("id").primaryKey().defaultRandom(),
...
var audioConfigRelations = relations(audioConfig, ({ one }) => ({
  user: one(users, {
    fields: [audioConfig.userId],
    references: [users.id]
  })
}));
var audioMessageCounterRelations = relations(audioMessageCounter, ({ one }) => ({
  user: one(users, {
    fields: [audioMessageCounter.userId],
    references: [users.id]
  })
}));
var insertAudioConfigSchema = createInsertSchema(audioConfig).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
var updateAudioConfigSchema = z.object({
  isEnabled: z.boolean().optional(),
  voiceType: z.enum(["female", "male"]).optional(),
  speed: z.string().optional()
  // String porque é numeric no DB
});
...
var sectorMembers = pgTable("sector_members", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
...
var routingLogs = pgTable("routing_logs", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  conversationId: varchar("conversation_id").notNull().references(() => conversations.id, { onDelete: "cascade" }),
...
var saasOwnerReports = pgTable("saas_owner_reports", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
...
var ticketClosureLogsV4 = pgTable("ticket_closure_logs", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  conversationId: varchar("conversation_id").notNull().references(() => conversations.id, { onDelete: "cascade" }),
  action: varchar("action", { length: 50 }).notNull(),
  // 'closed', 'reopened'
...
var bulkActionsLog = pgTable("bulk_actions_log", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
...
var connectionAgents = pgTable("connection_agents", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  connectionId: varchar("connection_id").notNull().references(() => whatsappConnections.id, { onDelete: "cascade" }),
  agentId: varchar("agent_id").notNull().references(() => agents.id, { onDelete: "cascade" }),
  isActive: boolean("is_active").default(true),
...
var connectionMembers = pgTable("connection_members", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  connectionId: varchar("connection_id").notNull().references(() => whatsappConnections.id, { onDelete: "cascade" }),
  memberId: varchar("member_id").notNull().references(() => teamMembers.id, { onDelete: "cascade" }),
...
var connectionAgentsRelations = relations(connectionAgents, ({ one }) => ({
...
var connectionMembersRelations = relations(connectionMembers, ({ one }) => ({
...
var sectorsRelations = relations(sectors, ({ many }) => ({
  members: many(sectorMembers),
  routingLogs: many(routingLogs)
}));
var sectorMembersRelations = relations(sectorMembers, ({ one }) => ({
...
var routingLogsRelations = relations(routingLogs, ({ one }) => ({
...
var scheduledMessagesRelations = relations(scheduledMessages, ({ one }) => ({
...
var insertSectorMemberSchema = createInsertSchema(sectorMembers).omit({
  id: true,
  assignedAt: true
});
...
var scheduledMessageSchema = z.object({
  conversationId: z.string(),
  messageText: z.string().min(1, "Mensagem \xE9 obrigat\xF3ria"),
  messageType: z.enum(["text", "ai_generated", "template"]).default("text"),
  aiPrompt: z.string().optional(),
  scheduledAt: z.date().or(z.string()),
  timezone: z.string().default("America/Sao_Paulo")
});
var insertConnectionAgentSchema = createInsertSchema(connectionAgents).omit({
  id: true,
  assignedAt: true
});
var insertConnectionMemberSchema = createInsertSchema(connectionMembers).omit({
  id: true,
  assignedAt: true
});
var connectionAgentSchema = z.object({
  connectionId: z.string().min(1, "Conex\xE3o \xE9 obrigat\xF3ria"),
  agentId: z.string().min(1, "Agente \xE9 obrigat\xF3rio"),
  isActive: z.boolean().default(true),
  assignedBy: z.string().optional()
});
var connectionMemberSchema = z.object({
  connectionId: z.string().min(1, "Conex\xE3o \xE9 obrigat\xF3ria"),
  memberId: z.string().min(1, "Membro \xE9 obrigat\xF3rio"),
  canView: z.boolean().default(true),
  canRespond: z.boolean().default(true),
  canManage: z.boolean().default(false)
});
var conversationScheduledMessages = pgTable("conversation_scheduled_messages", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  conversationId: varchar("conversation_id").references(() => conversations.id, { onDelete: "cascade" }),
  userId: varchar("user_id").references(() => users.id, { onDelete: "cascade" }),
  contactNumber: text("contact_number").notNull(),
...
var smartQrcodes = pgTable("smart_qrcodes", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  userId: varchar("user_id").notNull().references(() => users.id, { onDelete: "cascade" }),
...
var qrcodeScanLogs = pgTable("qrcode_scan_logs", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
...
var smartQrcodesRelations = relations(smartQrcodes, ({ one, many }) => ({
  user: one(users, {
...
var qrcodeScanLogsRelations = relations(qrcodeScanLogs, ({ one }) => ({
...
var insertSmartQrcodeSchema = createInsertSchema(smartQrcodes).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
  qrData: true,
...
var smartQrcodeSchema = z.object({
  name: z.string().min(1, "Nome \xE9 obrigat\xF3rio").max(200),
  description: z.string().max(1e3).optional().nullable(),
  slug: z.string().max(100).regex(/^[a-z0-9-]+$/, "Use apenas letras min\xFAsculas, n\xFAmeros e h\xEDfens").optional().nullable(),
  whatsappNumber: z.string().min(8, "N\xFAmero WhatsApp inv\xE1lido").max(30),
  ...
  foregroundColor: z.string().regex(/^#[0-9A-Fa-f]{6}$/, "Cor inv\xE1lida").default("#000000"),
  backgroundColor: z.string().regex(/^#[0-9A-Fa-f]{6}$/, "Cor inv\xE1lida").default("#ffffff"),
  logoUrl: z.string().url().optional().nullable(),
  ...
  targetUrl: z.string().url("URL inv\xE1lida"),
  qrSize: z.number().int().min(200).max(1200).default(400),
  isActive: z.boolean().default(true)
});
var updateSmartQrcodeSchema = smartQrcodeSchema.partial().omit({ targetUrl: true });
var businessCategories = pgTable("business_categories", {
  ...
  icon: varchar("icon", { length: 10 }).notNull().default("\u{1F4AC}"),
  description: text("description"),
...
export {
  ...
  smartQrcodes,
  qrcodeScanLogs,
  smartQrcodesRelations,
  qrcodeScanLogsRelations,
  insertSmartQrcodeSchema,
  smartQrcodeSchema,
  updateSmartQrcodeSchema,
  businessCategories,
  schema_exports
};

...
class PixComponentAmount
{
     ...
     * @since 3.0.0
     */
    const TYPES = [self::TYPE_ORIGINAL, self::TYPE_WITHDRAW, self::TYPE_FEES, self::TYPE_FINE, self::TYPE_REBATE, self::TYPE_DISCOUNT, self::TYPE_EXCHANGE];
    /**
     * Type.
     *
     * @since 3.0.0
    ...
    {
        $this->amount = \is_float($original) ? $original : \floatval($original);
        return $this;
    }
    /**
     * Get modality agent.
    ...
    {
        $this->modalityAgent = $modalityAgent;
        return $this;
    }
    /**
    ...
    {
        $this->providerOfWithdrawalService = $providerOfWithdrawalService;
        return $this;
    }
    /**
    ...
    {
        Helper::fill($data, $this, ['modalidadeAgente' => 'setModalityAgent', 'prestadorDoServicoDeSaque' => 'setProviderOfWithdrawalService']);
        return $this;
    }
    /**
     * Create a new entity.
